...
var data_Man = [
  {
    ...
    name_en: "Mai SamiJaber",
    id: 345678,
    Dth: "1999/1/18",
    phone: 487676388,
    genders: "ذكر",
    address: "غزة",
    classstd: { branch: "علمي", level: 5, class: " السابع " },
  },
];

function Profile_std() {
  return (
    <Grid className="profile_man">
      <Grid className="Datas_man">
        ...
        {data_Man.map((data) => (
          <Grid>
            <Grid className="QQ">
              <label className="AA"> اسم الطالب :</label>
              ...
              <label className="AA"> رقم الهوية :</label>
              ...
              <label className="AA "> العنوان :</label>
            ...
            <Grid className="mern">
              ...
              <label className=" ww "> المرحلة :</label>
              <label className="Aa ">{data.classstd.branch}</label>
              <br />
              <br />

              <label className=" ww "> الصف :</label>
              <label className="Aa ">{data.classstd.class}</label>
              <br />
              <br />

              <label className="ww "> الشعبة:</label>
